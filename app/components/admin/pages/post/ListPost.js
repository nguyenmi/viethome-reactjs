...
class ListPost extends React.Component{
    ...
    deleteCate(id) {
      ...
      if( deletecate === true) {
        axios({
          method: 'DELETE',
          url: `http://49.156.53.36:3000/api/posts/${id}`,
        }).then(response => {
    ...
    render(){
        ...
        return (
          <tr key={item.id}>
            ...
            <button  className="btn-edit" type="button" name="button">
              <a className="link-edit" href={`/#/admin/editpost/${item.id}`}>Edit</a>
            </button>
      ...
      return (
        <div className="content-wrapper">
  			    ...
  			    <h1 className="title-dash">Post Table
              <small className="small-viet">preview of Post tables</small>
            </h1>
  				</div>
            ...
            <div className="content-boxheader">
              <div className="box-create">
                <div className="btn-all">
                  <a href="#/admin/createpost" className="link-admin">Create Post</a>
                </div>
              </div>
